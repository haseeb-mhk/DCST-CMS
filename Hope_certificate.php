...
<table style="width: 100%" border=0>
  ...
  <h4 align="center">
  	...
  	<table width="100%" border="0" cellspacing="0" style="margin-top: 15px;">
  		...
  		<tr >
  			<td colspan="2" style="text-align:justify; line-height: 2; padding 10px;"> <span style="font-family: Old English Five; font-size: large; font-size: 20.5px ">It is certify that <span style="text-decoration: underline"><b><?php if($gender=='Male') echo 'Mr'; else echo 'Miss'; ?> <?php echo $name;?> </b>  <?php if($gender=='Male') echo 'S/O'; else echo 'D/O'; ?>  <b><?php echo $father_name?></b></span> is a regular student of BS-<?php if($program == "BCS"){echo("Computer Science");} elseif($program=="BS_IT"){echo("Information Technology");} else{echo("Software Engineering");}?><i> </i>at the Department of Computer and Software Technology, University of Swat having Roll No. <?php echo $roll ?> and under Registration No. <?php echo($reg_no)?> session <?php echo($Session) ?>. Furthermore, it is hoped that <?php if($gender=='Male') echo 'he'; else echo 'she'; ?> will complete all the requirements of <?php if($gender=='Male') echo 'his'; else echo 'her'; ?> BS (<?php if($program == "BCS"){echo("Computer Science");} elseif($program=="BS_IT"){echo("Information Technology");} else{echo("Software Engineering");}?>) degree in spring _____. <?php if($gender=='Male') echo 'He'; else echo 'She'; ?> is regular and hardworking, obedient student having good moral conduct.
				<br>
				<br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; This certificate is issued on the request of <?php if($gender=='Male') echo 'Mr'; else echo 'Miss'; ?> <?php echo $name;?> 
