...
<div id="container">
  ...
  <h4 align="center">
  	...
  	<table width="100%" border="0" cellspacing="0" style="margin-top: 15px;">
  		...
  		<tr >
  			<td colspan="2" style="text-align:justify;  padding 10px;"> <span style="font-family: Old English Five; font-size: large; font-size: 20.5px ">It is my pleasure to write a few words in favor of <span style="text-decoration: underline"><b><?php if($gender=='Male') echo 'Mr'; else echo 'Miss'; ?> <?php echo $name;?> </b>  <?php if($gender=='Male') echo 'S/O'; else echo 'D/O'; ?>  <b><?php echo $father_name?></b></span> is known to me for the last 4 years as student of <b style="text-decoration: underline"> BS- <?php if($program == "BCS"){echo("Computer Science");} elseif($program=="BS_IT"){echo("Information Technology");} else{echo("Software Engineering");}?></b> in Session <?php echo($Session)?>, at the Department of Computer & Software Technology, University of Swat. I found <?php if($gender=='Male') echo 'him'; else echo 'her'; ?> hardworking and intelligent while performing <?php if($gender=='Male') echo 'his'; else echo 'her'; ?> assignments. <?php if($gender=='Male') echo 'He'; else echo 'She'; ?> has proved himself to be a devoted and hardworking student. <?php if($gender=='Male') echo 'His'; else echo 'Her'; ?> understanding towards the computational problems is appreciable. <?php if($gender=='Male') echo 'He'; else echo 'She'; ?> has the ability to work independently as well as in collaboration with others.<br>
<br>
				I found that <?php if($gender=='Male') echo 'he'; else echo 'she'; ?> has both aptitude and devotion for quality research work and is well suited to pursue Master Studies in <?php if($gender=='Male') echo 'his'; else echo 'her'; ?> chosen field of interest. I hope that <?php if($gender=='Male') echo 'he'; else echo 'she'; ?> will prove himself as a good and potential candidate.
				<br><br>

				I wish him all the best in  <?php if($gender=='Male') echo 'his'; else echo 'her'; ?> future.
<br>
...
<br>
		...
		<div align="center" style="margin-left: 380px">
			<span style="font-family: Old English Five; font-size: large" ><b>Dr. Kifayat Ullah</b><br>
				Assistt. Professor in C&amp;ST<br>
							<span style="font-size: medium"> University of Swat, KPK Pakistan <br>
				<i>Email: kifayat@uswat.edu.pk</i><br>

				<i>Ph. #:+92-946-881089</i>
								</span>
