...
if(isset($_POST["btnsub"])){
	...
	$gender  = $_POST['gender'];
	$program_apply  = $_POST['std_program'];
	$Graduation_date  = $_POST['Graduation_date'];
//	echo($roll_no);
	header("location:provisional_certificate.php?id=".$roll_no."&gender=".$gender."&A_program=".$program_apply."&g_date=".$Graduation_date);
              ...
              <form role="form" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="std_rollno"name="Graduation_date" required>
                  </div>
