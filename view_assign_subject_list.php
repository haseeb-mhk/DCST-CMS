  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View Semester Wise Award Lists</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
$Sub_Name = $s_r[2];		  
                    ...
                    <tr>
                      <td><?php echo($i) ?></td>
                      <td>  <a href="view_award_list.php?sub_id=<?php echo $row['assign_subject_id']?>&sem_id=<?php echo($row['Semester_Id']); ?>&sub_cod=<?php echo($s_r[1]);?>">
