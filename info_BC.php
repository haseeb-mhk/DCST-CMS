...
if(isset($_POST["btnsub"])){
	...
	$gender  = $_POST['gender'];
//	echo($roll_no);
	header("location:Bonified_certificate.php?id=".$roll_no."&gender=".$gender);
...
<head>
  ...
  <title>Home | Bonified Certificate</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Bonified Certificate</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
