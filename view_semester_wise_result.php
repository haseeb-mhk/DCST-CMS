  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Semester wise GPA Results Sheet</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
           ...
           <div class="row">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" name="form1" method="post" action="result_sheet_sls.php">
                <div class="card-body">
                  <div class="form-group">
                     <label> Semester</label>
                  <select class="form-control select2 "  style="width: 100%;" data-dropdown-css-class="select2-purple" name="semester">
                  ...
                  <div class="form-group">
                     <label> session</label>
                  <select class="form-control select2 "  style="width: 100%;" data-dropdown-css-class="select2-purple" name="session">
...
//	$discipline = "Bachelor's";
	$select_batches = mysqli_query($con,"select * from batches where Discipline = 'Master'");
          ...
          <option value="BS-IT">BS-IT</option>
					    ...
					    <div class="form-group">
                     <label>Shift</label>
                  <select class="form-control select2 "  style="width: 100%;" data-dropdown-css-class="select2-purple" name="sh">
