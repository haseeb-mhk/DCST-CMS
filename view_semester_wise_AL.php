  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Semester Wise Award Lists</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<div class="row">
	...
	while($row = mysqli_fetch_array($current_Semesters)){ 
                    ...
                    <tr>
                      <td><?php echo($i) ?></td>
                      <td>  <a href="shift.php?sem_id=<?php echo $row['semester_id']; ?>&source=view_semester_wise_AL.php">
					  Award list for semester <?php echo $row['semester']; ?> 
